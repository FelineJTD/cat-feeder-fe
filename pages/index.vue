...
<template>
  <div>
    ...
    <div class="min-h-screen mobile-landscape:min-h-screen mobile-landscape:h-fit md:h-[calc(100vh+0.5px)] w-full flex flex-col mobile-landscape:flex-row mobile-landscape:gap-12 mobile-landscape:pt-20 mobile-landscape:pb-8 md:-pt-[0.5px] pt-48 pb-16 md:py-0 px-8 mobile-landscape:px-8 md:px-16 lg:px-32 bg-neutral-950/50 text-white">
